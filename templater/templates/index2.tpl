...
<title>LeetPress - A Gaming HTML Template</title>
			...
			<div class="featured-item" style="background:#000 url(./images/feat2.jpg) no-repeat center; height:280px;">
				...
				<div class="featured-inner">
					...
					<div class="featured-inner">
						...
						<h1><a href="./news-post.html">Dead Space 2 breaks all sales records</a></h1>
			...
			<div class="featured-item" style="background:#000 url(./images/feat5.jpg) no-repeat center; height:280px;">
				...
				<div class="featured-inner">
					...
					<div class="featured-inner">
						...
						<div class="featured-arrows"></div>
						<h1><a href="./news-post.html">Minecraft sells over 1 million copies in on year</a></h1>
						<p class="featured-meta">By Sebastian Rosenkvist, March 14, 2011</p>
	...
	<div id="main-wrapper">
		...
		<div id="sidebar">
			...
			<div class="widget">
				...
				<h4 class="widget-title tabs">Latest Reviews</h4>
				
				<div class="panel-wrapper">
					<a href="#panel-1" rel="panel" class="selected">All</a>
					<a href="#panel-2" rel="panel">Xbox 360</a>
					<a href="#panel-3" rel="panel">PS3</a>
					<a href="#panel-4" rel="panel">PC</a>
					<a href="#panel-5" rel="panel">Wii</a>
				</div>
				...
				<h4 class="widget-title">Latest Media</h4>
					...
					<div class="side-item">
						...
						<div class="media-thumb">
							...
							<a href="./screenshot-post.html"><img src="./images/mediathumb.jpg" alt="" /></a>
						</div>
					...
					<div class="side-item">
						...
						<div class="media-thumb">
							...
							<a href="./video-post.html"><img src="./images/mediathumb2.jpg" alt="" /></a>
						</div>
					...
					<div class="side-item">
						...
						<div class="media-thumb">
							<div class="screenshot-icon"></div>
							<a href="./screenshot-post.html"><img src="./images/mediathumb3.jpg" alt="" /></a>
						</div>
