<?php /* Smarty version Smarty-3.0.8, created on 2011-07-26 13:30:27
         compiled from "./templates/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11868528074e2e97430938b3-66895313%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '11868528074e2e97430938b3-66895313',
  'function' => 
  array (
  ),
  'has_nocache_code' => true,
)); /*/%%SmartyHeaderCode%%*/?>
<?php if (!is_callable('smarty_modifier_capitalize')) include '/var/www/new_monitor/libs/plugins/modifier.capitalize.php';
if (!is_callable('smarty_modifier_date_format')) include '/var/www/new_monitor/libs/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_html_select_date')) include '/var/www/new_monitor/libs/plugins/function.html_select_date.php';
if (!is_callable('smarty_function_html_select_time')) include '/var/www/new_monitor/libs/plugins/function.html_select_time.php';
if (!is_callable('smarty_function_html_options')) include '/var/www/new_monitor/libs/plugins/function.html_options.php';
?><?php echo '/*%%SmartyNocache:11868528074e2e97430938b3-66895313%%*/<?php if (!is_callable(\'smarty_modifier_capitalize\')) include \'/var/www/new_monitor/libs/plugins/modifier.capitalize.php\';
if (!is_callable(\'smarty_modifier_date_format\')) include \'/var/www/new_monitor/libs/plugins/modifier.date_format.php\';
?>/*/%%SmartyNocache:11868528074e2e97430938b3-66895313%%*/';?>
...
The value of {$Name} is <b><?php echo '/*%%SmartyNocache:11868528074e2e97430938b3-66895313%%*/<?php echo $_smarty_tpl->getVariable(\'Name\')->value;?>
/*/%%SmartyNocache:11868528074e2e97430938b3-66895313%%*/';?></b>

variable modifier example of {$Name|upper}

<b><?php echo '/*%%SmartyNocache:11868528074e2e97430938b3-66895313%%*/<?php echo ((mb_detect_encoding($_smarty_tpl->getVariable(\'Name\')->value, \'UTF-8, ISO-8859-1\') === \'UTF-8\') ? mb_strtoupper($_smarty_tpl->getVariable(\'Name\')->value,SMARTY_RESOURCE_CHAR_SET) : strtoupper($_smarty_tpl->getVariable(\'Name\')->value));?>
/*/%%SmartyNocache:11868528074e2e97430938b3-66895313%%*/';?></b>
